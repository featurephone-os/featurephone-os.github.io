...
LJ supported only GSM/UMTS stack, so CDMA versions of the same phone models usually ran [REX OS]({% post_url 2023-05-10-rex-os %}), or [P2K]({% post_url 2023-05-10-p2k %}).
